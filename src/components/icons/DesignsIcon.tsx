...
export const DesignsIcon: React.FC = () => {
	return (
		<svg
			fill='hsla(23, 93%, 67%, 1)'
			height='35'
			width='35'
			version='1.2'
			baseProfile='tiny'
		...
		>
			<path
				d='M-876.9,938.4l-7.7,7.6l-58.9,58.6l-72.1-72.1c-1.8-1.7-4.6-1.7-6.4,0l-37.9,37.9c-1.7,1.7-1.7,4.6,0,6.4l8.9,8.9l6.7-6.7
